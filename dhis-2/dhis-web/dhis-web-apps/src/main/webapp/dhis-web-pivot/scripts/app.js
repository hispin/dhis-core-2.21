Ext.onReady( function() {
	...
	createViewport = function() {
        ...
        onEventDataItemProgramSelect = function(programId, skipSync) {
            ...
            Ext.Ajax.request({
                url: ns.core.init.contextPath + '/api/programs.json?paging=false&fields=programTrackedEntityAttributes[trackedEntityAttribute[id,' + namePropertyUrl + ',valueType]],programStages[programStageDataElements[dataElement[id,' + namePropertyUrl + ',valueType]]]&filter=id:eq:' + programId,
                success: function(r) {
                    r = Ext.decode(r.responseText);

...
public class PieProgReviewTAReportResultAction implements Action 
{
    ...
    public String execute()
    {
        ...
        */
        ...
        for( String selReview : selectedList )
        {
            ...
            dataElementIdsByComma += "," + selReview.split( ":" )[4];
            dataElementIdsByComma += "," + selReview.split( ":" )[5];
            dataElementIdsByComma += "," + selReview.split( ":" )[6];
            dataElementIdsByComma += "," + selReview.split( ":" )[7];
        ...
        while ( orgUnitIterator.hasNext() )
        {
            ...
            for( String selReview : selectedList )
            {
                ...
                if( dv2 != null && dv2.getComment() != null )
                {
                    reviewList.add( dv2.getComment() );
                }
                else
                {
                    reviewList.add( " " );
                }
                //System.out.println( selReview.split( ":" )[3] + " " + reviewList.get(4) );
                
                dv2 = dataValueMap.get( orgUnit.getId()+":"+selReview.split( ":" )[4] );
                if( dv2 != null && dv2.getValue() != null )
                {
                    reviewList.add( dv2.getValue() );
                }
                ...
                //System.out.println( selReview.split( ":" )[4] + " " + reviewList.get(5) );
                
                dv2 = dataValueMap.get( orgUnit.getId()+":"+selReview.split( ":" )[5] );
                if( dv2 != null && dv2.getValue() != null )
                {
                    reviewList.add( dv2.getValue() );
                }
                ...
                //System.out.println( selReview.split( ":" )[5] + " " + reviewList.get(6) );
                
                dv2 = dataValueMap.get( orgUnit.getId()+":"+selReview.split( ":" )[6] );
                if( dv2 != null && dv2.getComment() != null )
                {
                    reviewList.add( dv2.getComment() );
                }
                ...
                //System.out.println( selReview.split( ":" )[6] + " " + reviewList.get(7) );
                
            	int hqP = 0;
            	int rqR = 0;
                try
                {
                	if( !reviewList.get( 5 ).trim().equals("") )
                	{
                		hqP = Integer.parseInt( reviewList.get( 5 ) );
                	}
                	
                	if( !reviewList.get( 6 ).trim().equals("") )
                	{
                		rqR = Integer.parseInt( reviewList.get( 6 ) );
                	}
                	
                	int total = hqP + rqR;
                	reviewList.add( total + "" );
                }
                catch( Exception e )
                {
                	reviewList.add( (hqP + rqR)+"" );
                }

                dv2 = dataValueMap.get( orgUnit.getId()+":"+selReview.split( ":" )[7] );
                if( dv2 != null && dv2.getValue() != null )
                {
                    reviewList.add( dv2.getValue() );
                }
                ...
                //System.out.println( reviewList.size() + " : " + reviewList.get( 7 ) );
                ...
                else
                {
                    ...
                    {
                    	//System.out.println( " between sdate and enddate ");
                        reviewResultMap.put( orgUnit.getId()+":"+selReview.split( ":" )[0], reviewList );
                    }
                }
            }
    ...
    private Date getStartDateByString( String dateStr )
    {
        ...
        else if ( startDateParts[1].equalsIgnoreCase( "Q1" ) )
        {
            ...
            //startDate = startDateParts[0] + "-01-01";
            //startDate = startDateParts[0] + "-03-01";
        }
        else if ( startDateParts[1].equalsIgnoreCase( "Q2" ) )
        {
        	...
        	{
        		startDate = startDateParts[0] + "-06-01";
        	}
        	//startDate = startDateParts[0] + "-06-01";
        }
        else if ( startDateParts[1].equalsIgnoreCase( "Q3" ) )
        {
        	if( cal.get( Calendar.MONTH ) >= 6 && cal.get( Calendar.MONTH ) <= 8 )
        	{
        		startDate = startDateParts[0] + curMonth + curDay;
        	}
        	else
        ...
        {
        	if( cal.get( Calendar.MONTH ) >= 9 && cal.get( Calendar.MONTH ) <= 11 )
        	{
        		startDate = startDateParts[0] + curMonth + curDay;
        	}
        	else
